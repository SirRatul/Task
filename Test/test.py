...
class AutomationTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.driver = webdriver.Chrome(executable_path="H:\chromedriver.exe")
    ...
    def test_Automation(self):
        ...
        reg_Page_obj.enter_first_name("Samsul")
        reg_Page_obj.enter_last_name("Islam")
        reg_Page_obj.enter_pass("123456")
        reg_Page_obj.select_birthday(26)
        reg_Page_obj.select_birth_month(9)
        reg_Page_obj.select_birth_year(22)
        reg_Page_obj.enter_address("Dhaka")
        reg_Page_obj.enter_city("Dhaka")
        reg_Page_obj.select_state(5)
        reg_Page_obj.enter_postcode(1236)
        reg_Page_obj.enter_mobile_num(1521431231)
        reg_Page_obj.enter_address_alias("Dhaka")
        ...
        reg_Page_obj = RegisterPage(driver)
        reg_Page_obj.select_gender()
        reg_Page_obj.enter_first_name("Tasnim")
        reg_Page_obj.enter_last_name("Islam")
        reg_Page_obj.enter_pass("123456")
        reg_Page_obj.select_birthday(21)
        reg_Page_obj.select_birth_month(12)
        reg_Page_obj.select_birth_year(24)
        reg_Page_obj.enter_address("Rajshahi")
        reg_Page_obj.enter_city("Rajshahi")
        reg_Page_obj.select_state(5)
        reg_Page_obj.enter_postcode(1234)
        reg_Page_obj.enter_mobile_num(1521431231)
        reg_Page_obj.enter_address_alias("Rajshahi")
        reg_Page_obj.click_create_acc()
